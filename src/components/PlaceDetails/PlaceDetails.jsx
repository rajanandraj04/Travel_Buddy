            ...
            <CardContent>
                ...
                {place?.awards?.map((award)=>(
                    <Box my={1} display="flex" justifyContent="space-between" alignItems="center">
                       ...
                       <Typography variant="susbtile2" color="textSecondary" >{award.display_name}</Typography>
                ...
                {place?.address && (
                    <Typography gutterBottom variant="subtitle2" color="textSecondary" className={classes.subtile} >
                ...
                <CardActions>
                    ...
                    <Button size="small" color="primary" align="right" onClick={()=> window.open(place.website, 'blank')} >
                        Website
                    </Button>
                </CardActions>
            </CardContent>
